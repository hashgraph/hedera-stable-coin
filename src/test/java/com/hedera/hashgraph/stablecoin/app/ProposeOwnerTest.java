...
public class ProposeOwnerTest {
    ...
    public void proposeOwnerTest() throws InvalidProtocolBufferException, SQLException {
        ...
        // Update State
        topicListener.handleTransaction(Instant.EPOCH, Transaction.parseFrom(proposeOwnerTransaction2.toByteArray()));

        // Check that status is the correct failure type
        Assertions.assertEquals(Status.PROPOSE_OWNER_ADDRESS_NOT_SET, getTransactionStatus.status);
    }
}
